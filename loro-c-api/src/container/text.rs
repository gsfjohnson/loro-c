...
#[no_mangle]
pub extern "C" fn loro_text_is_deleted(text: *const LoroText) -> bool {
    ffi_guard!(false, {
        let text = deref_or!(text, false);
        loro::ContainerTrait::is_deleted(text.inner())
    })
}

/// Returns whether this text container is attached to a document.
#[no_mangle]
pub extern "C" fn loro_text_is_attached(text: *const LoroText) -> bool {
    ffi_guard!(false, {
        let text = deref_or!(text, false);
        loro::ContainerTrait::is_attached(text.inner())
    })
}
...
#[no_mangle]
pub extern "C" fn loro_text_get_attached(text: *const LoroText) -> *mut LoroText {
    ffi_guard!(std::ptr::null_mut(), {
        let text = deref_or!(text, std::ptr::null_mut());
        match loro::ContainerTrait::get_attached(text.inner()) {
...
#[no_mangle]
pub extern "C" fn loro_text_doc(text: *const LoroText) -> *mut LoroDoc {
    ffi_guard!(std::ptr::null_mut(), {
        let text = deref_or!(text, std::ptr::null_mut());
        match loro::ContainerTrait::doc(text.inner()) {
...
#[no_mangle]
pub extern "C" fn loro_text_subscribe(
    text: *const LoroText,
    ...
    ffi_guard!(std::ptr::null_mut(), {
        ...
        let doc = match loro::ContainerTrait::doc(text.inner()) {
            Some(d) => d,
        ...
        let sub = doc.subscribe(&loro::ContainerTrait::id(text.inner()), subscriber);
...
#[no_mangle]
pub extern "C" fn loro_text_get_editor_at_unicode_pos(
    text: *const LoroText,
    pos: usize,
    out: *mut u64,
) -> bool {
    ffi_guard!(false, {
        ...
        match text.inner().get_editor_at_unicode_pos(pos) {
            Some(peer) => {
